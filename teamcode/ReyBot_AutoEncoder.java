...
@Autonomous(name="ReyBot: Auto Drive Red Alliance", group = "ReyBot")
public class ReyBot_AutoEncoder extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        sleep(500);
        //Move forward a bit
        encoderDrive(0.60, 0.50, 20, 20, 5.0);
        sleep(500);
        //Move in a curve
        ReyBot.leftDriveFront.setPower(0.8);
